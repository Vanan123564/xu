...
def banner():
  ...
  print((Fore.BLUE) +f"""                            ╔╗ ╔═╗╦═╗╔╦╗╦═╗╦╔═╗╦╔═  ╦╦
                            ╠╩╗╠═╣╠╦╝ ║ ╠╦╝║║  ╠╩╗  ║║
                            ╚═╝╩ ╩╩╚═ ╩ ╩╚═╩╚═╝╩ ╩  ╩╩
                          𝓑𝓪𝓽𝓻𝓲𝓬𝓴, Dominating since 2022
                       ╚═══╦══════════════════════════╦═══╝
                ╚╔═════════╩════════[𝓑𝓪𝓽𝓻𝓲𝓬𝓴]════════╩═════════╗╝
                ╚║ Welcome we created 𝓑𝓪𝓽𝓻𝓲𝓬𝓴 𝓥 2 year 2023 ║╝
                ...
                ╚╔╩════════════════════════════════════════════╩╗╝
                ╚║            Powered by 𝓑𝓪𝓽𝓻𝓲𝓬𝓴               ║╝
                ╚║Copyright © 2023 𝓑𝓪𝓽𝓻𝓲𝓬𝓴 All Rights Reserved ║╝
                ╚╚══════════════════════════════════════════════╝╝
...
def main():
    while(True):
        cnc = input(Fore.RED +'''                   root@botnet :[1;30m''')
        if cnc == "methods" or cnc == "Methods" or cnc == "m" or cnc == "mth" or cnc == "1":
            ...
            print(f"""
                  ...
                  [38;2;255;0;255m [1;36m𝑫𝑫𝒐𝑺,[1;31m𝑶𝒃𝒔𝒆𝒔𝒔𝒆𝒅 𝑾𝒊𝒕𝒉 𝒀𝒐𝒖 𝓥𝓪̆𝓷 𝓐𝓷
...
ZALO: 𝓥𝓪̆𝓷 𝓐𝓷
            ...
            try:
                cmmnd = cnc.split()[0]
                print("Error: [ " + cmmnd + " ] Sai Lệnh Kìa ĐỤ MẸ MÀY !!!!")
            except IndexError:
                pass
main()
